...
export default function Header() {
    return (
        <div className="relative">
            <CarouselHeader />
            <div className="bg-primary-dark/50 absolute top-0 left-0 w-full h-full z-10">
                <Navbar isWhite />
            </div>
            <div className="bg-white/25 absolute top-1/2 translate-y-[-50%] left-0 w-full z-10 p-10">
